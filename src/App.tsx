        ...
        <main className="flex-1 px-4 md:px-0 py-6 md:py-8 w-full max-w-[800px] mx-auto">
          <AnimatePresence mode="wait">
            ...
            >
              ...
              {/* Completed Tasks Accordion / Container */}
              {completedTasks.length > 0 && (
                <div className="bg-white rounded-[12px] border border-[#e0e0e0] shadow-2xs overflow-hidden space-y-0">
                  <div className="bg-[#f8f9fa] px-6 py-3.5 border-b border-[#e0e0e0] flex items-center justify-between">
                    <span className="font-title text-sm font-bold text-[#24a148] flex items-center gap-2">
                      <span>✓ Công việc đã hoàn thành</span>
                      <span className="font-num text-xs bg-[#e2f6e9] px-2.5 py-0.5 rounded-full">
